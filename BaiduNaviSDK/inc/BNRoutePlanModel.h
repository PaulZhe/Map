...
@property (nonatomic, assign) NSInteger longitude; /**< 国测局坐标经度* SEARCH_POINT_RATIO */
@property (nonatomic, assign) NSInteger latitude; /**< 国测局坐标纬度* SEARCH_POINT_RATIO */
 ...
 * 诱导坐标
 */
@property (nonatomic, strong) BMSearchPoint *guidePoint;

/**
 * 显示坐标
 */
@property (nonatomic, strong) BMSearchPoint *viewPoint;

/**
 * 地址信息
 */
@property (nonatomic, copy) NSString *strDiscription;

/**
 * POI距中心点或者起点的直线距离
 */
@property (nonatomic, assign) NSInteger unCurPosDistance;
