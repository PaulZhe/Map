...
@interface MAPShowAudioViewController () <UITableViewDelegate>

@end

@implementation MAPShowAudioViewController
...
//        self.dynamicStateView.typeMotiveString = [NSString stringWithFormat:@"%d", 3];
//    }
