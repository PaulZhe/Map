//
//  MAPShowPicturesViewController.m
//  Map
//
...
@interface MAPShowPicturesViewController () <UITableViewDelegate>

@end

@implementation MAPShowPicturesViewController
...
- (void)viewDidLoad {
    ...
    if (!_dynamicStateView) {
        ...
        self.dynamicStateView.dyanmicStateTableView.delegate = self;
        [self.view addSubview:_dynamicStateView];
        self.dynamicStateView.typeMotiveString = [NSString stringWithFormat:@"%d", 2];
    }
}
